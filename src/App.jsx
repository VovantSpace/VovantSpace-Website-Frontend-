...
const LandingPage = () =>
{
  ...
  return (
    <div className=" bg-[#31473A] text-white relative overflow-hidden">
      <Navbar />
      {/* Main Section */}
      <main className="xl:container md:h-[31rem] lg:h-[27rem] mx-auto grid md:grid-cols-2 justify-center md:justify-start text-center md:text-left px-4 lg:px-28 relative z-10 mt-2">
        <div className="max-w-2xl space-y-5 mt-14">
          ...
          >
            {['Explore Projects', 'Explore Mentors'].map( ( text ) => (
              ...
              >
                {text}
                <FiChevronRight className="ml-2 bg-[#31473A] text-white rounded-full p-1 text-2xl font-bold" />
              </motion.a>
            ) )}
          </motion.div>
        </div>
