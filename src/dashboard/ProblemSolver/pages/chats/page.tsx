...
const channels: Channel[] = [
  {
    ...
    unreadCount: 3,
    description: "Channel for discussing AI and smart farming technologies",
  },
  {
    id: "2",
    name: "#ai-smart-farming2",
    unreadCount: 0,
    description: "Channel for sustainable energy solutions",
  },
]
      ...
      <div className="fixed ">
        <div className="p-4">
          <div className="relative w-[206px]">
            ...
            <Input placeholder="Search Challenge" className="secondbg pl-9 border dashborder dashtext focus:outline-none text-sm" />
          </div>
        </div>
