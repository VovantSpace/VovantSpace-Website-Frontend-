            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2">
                    ...
                    {isEditing ? (
                        ...
                        <p className="text-sm dark:text-white">{new Date(education.startYear).toLocaleDateString('en-US', {
                            year: 'numeric',
                            month: 'long'
                        })}</p>
                    )}
                ...
                <div className="space-y-2">
                    ...
                    {isEditing ? (
                        ...
                        <p className="text-sm dark:text-white">{new Date(education.endYear).toLocaleDateString('en-US', {
                            year: 'numeric',
                            month: 'long'
                        })}</p>
                    )}
