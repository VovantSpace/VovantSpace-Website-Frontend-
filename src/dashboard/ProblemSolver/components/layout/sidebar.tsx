...
const sidebarLinks = [
  { icon: Home, label: "Home", href: "/dashboard/ps" },
  { icon: FileText, label: "Explore Challenges", href: "/dashboard/ps/my-challenges" },
  { icon: MessageSquare, label: "Challenge Chats", href: "/dashboard/ps/chats" },
  { icon: BarChart2, label: "Analytics", href: "/dashboard/ps/analytics" },
  { icon: Wallet, label: "Wallet", href: "/dashboard/ps/wallet" },
  { icon: Bell, label: "Alerts", href: "/dashboard/ps/alerts" },
]
