...
export function MentorProfileDialog({ open, onOpenChange, mentor, onBookSession }) {
  return (
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            {mentor.education && mentor.education.length > 0 ? (
                ...
                {mentor.education.map((edu, index) => (
                  <div key={index} className="secondbg p-4 px-2 rounded-xl border border-[#2a3142]">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className="text-xs text-emerald-400">{edu.startDate} - {edu.endDate}</span>
                    </div>
              ...
              <p className="text-sm text-gray-700 dark:text-gray-300 mt-1">No Education Details Available.</p>
            )}
          </div>
          ...
          <div>
            ...
            {mentor.certifications && mentor.certifications.length > 0 ? (
              ...
              <p className="text-sm text-gray-700 dark:text-gray-300 mt-1">No certifications available.</p>
            )}
          </div>
          ...
          <div>
            ...
            {mentor.workExperience && mentor.workExperience.length > 0 ? (
              ...
              <p className="text-sm text-gray-700 dark:text-gray-300 mt-1">No work experience available.</p>
            )}
          </div>
                ...
                <div key={index} className="secondbg p-4 rounded-xl border border-[#2a3142]">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 dark:text-gray-300 text-sm mt-2">
                      "Absolutely phenomenal work! Delivered beyond expectations and provided valuable insights we hadn't even considered. Will definitely work with again."
                    </p>
                  </div>
