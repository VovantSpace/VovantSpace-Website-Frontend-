...
export function SendFundSettingsDialog({
    ...
    return (
        <Dialog open={isOpen} onOpenChange={handleClose}>
            <DialogContent
                className="secondbg dashtext dark:bg-gray-800 dark:text-white sm:max-w-[425px] max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                ...
                {currentView === "verifyOTPChangePin" && (
                    <div className="space-y-4">
                        ...
                        <DialogFooter>
                            ...
                            <Button variant="outline" className="dashbutton w-full text-white"
                ...
                {currentView === "changePin" && (
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <Input id="old-pin" placeholder="Enter old PIN" type="password"
                                   className="secondbg dark:bg-gray-700 mt-2"/>
                        </div>
                        <div>
                            <Label htmlFor="new-pin">New PIN</Label>
                            <Input id="new-pin" placeholder="Enter new PIN" type="password"
                                   className="secondbg dark:bg-gray-700 mt-2"/>
                        </div>
                        <DialogFooter>
                ...
                {currentView === "forgotPin" && (
                    <div className="space-y-4">
                        ...
                        <Input id="new-pin-forgot" placeholder="Enter new PIN" type="password"
                               className="secondbg dark:bg-gray-700 mt-2"/>
                        <DialogFooter>
