...
const mobileLinks = [
  { icon: Home, label: "Home", href: "/dashboard/innovator" },
  { icon: FileText, label: "My Challenges", href: "/dashboard/innovator/my-challenges" }, 
  { icon: MessageSquare, label: "Challenge Chats", href: "/dashboard/innovator/chats" },
  { icon: BarChart2, label: "Analytics", href: "/dashboard/innovator/analytics" },
  { icon: Wallet, label: "Wallet", href: "/dashboard/innovator/wallet" },
  { icon: Bell, label: "Alerts", href: "/dashboard/innovator/alerts" },
]
      ...
      <SheetContent side="left" className="w-[240px] secondbg p-0">
        ...
        <div className="flex items-center h-14 uppercase px-7 ">
          <div className="border border-gray-700 dark:border-gray-300 rounded-full p-1">
            <Link to={'/dashboard/innovator/profile'} className="dashtext  text-sm font-medium hover:underline">
