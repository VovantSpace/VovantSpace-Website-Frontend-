...
const sidebarLinks = [
  ...
  { icon: FileText, label: "Requests", href: "/dashboard/advisor/requests" },
  { icon: MessageSquare, label: "Session Chats", href: "/dashboard/advisor/chats" },
  { icon: BarChart2, label: "Availability", href: "/dashboard/advisor/availability" },
  { icon: Wallet, label: "Wallet", href: "/dashboard/advisor/wallet" },
  { icon: Bell, label: "Alerts", href: "/dashboard/advisor/alerts" },
]
    ...
    <div className="fixed left-0 top-0 hidden h-screen bottom-0 dashbg w-[240px] lg:block">
      ...
      <div className="flex items-center h-14 uppercase px-7 ">
        <div className="border border-gray-700 dark:border-gray-300  rounded-full p-1">
          <Link to={'/dashboard/advisor/profile'} className="dashtext  text-sm font-medium hover:underline">
