...
export function SessionCard({ initial, title, time, duration, details, expanded = false }) {
    ...
    return (
        <div className="mb-4 rounded-lg secondbg p-4 shadow-sm">
            ...
            >
                <div className="space-y-2 rounded-md secondbg p-4 py-1">
                    {details ? (
                        <>
            ...
            <RescheduleSession open={isOpen} onOpenChange={setIsOpen} />
        </div>
    );
}
...
SessionCard.propTypes = {
    /** Initial letter or short label (e.g. 'B' for Basil) */
    initial: PropTypes.string.isRequired,

    /** The session or mentee title */
    title: PropTypes.string.isRequired,

    /** The formatted start time (e.g. "10:00 AM") */
    time: PropTypes.string.isRequired,

    /** The formatted duration text (e.g. "1 hour") */
    duration: PropTypes.string.isRequired,

    /** Optional details object with extra session info */
