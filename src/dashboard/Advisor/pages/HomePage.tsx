...
import { useMentorDashboardSocket } from "@/hooks/useMentorDashboardSocket";
...
// Helper functions to group sessions by day using the full date as a key
...
export default function HomePage() {
    ...
    useMentorDashboardSocket(mentorId, handleDashboardRefresh);
