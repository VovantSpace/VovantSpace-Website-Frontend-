...
function Advisor({ formik }) {
    return (
        <div className='flex flex-col lg:flex-row gap-8 p-4 mx-auto '>
            <div className="flex-1 space-y-8 !max-w-[28rem]">
                ...
                <div className="space-y-6 ">
                        ...
                        <div className="relative">
                            <select
                                ...
                                onChange={e => {
                                    ...
                                    formik.setFieldValue('specialties', []); // Clear specialties when expertise changes
                                }}
                            ...
                            {formik.errors.expertise && formik.touched.expertise && (
                                <div className="text-red-500 text-sm mt-1">{formik.errors.expertise}</div>
                            )}
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        {formik.errors.specialties && formik.touched.specialties && (
                            <div className="text-red-500 text-sm mt-1">{formik.errors.specialties}</div>
                        )}
                    </div>
            ...
            <StickyCardContainer
                heading={`Advisor/Mentor Sign-Up Page`}
                para={<>
                    Make a lasting impact by mentoring the next generation of innovators, problem solvers, and changemakers. As a mentor on VovantSpace, you'll provide valuable career insights, technical expertise, and life guidance to help mentees navigate challenges and achieve their goals. Whether offering strategic advice, personal development support, or industry expertise, your mentorship can change lives. <br /> <i> Join now and start shaping the future!</i>
                </>}
                subheading={`Inspire. Guide. Transform.`}
            />
        </div>
    );
}
